...
pub fn redeem_nft_for_swap(ctx: Context<RedeemNftForSwap>) -> Result<()> {
...
#[derive(Accounts)]
pub struct RedeemNftForSwap<'info> {
    #[account(mut)]
...
#[event]
pub struct RedeemNftForSwapEvent {
    pub signer: Pubkey,
    pub nft_mint: Pubkey,
